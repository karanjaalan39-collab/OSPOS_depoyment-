...
$routes->post('mpesa/pay',         'Mpesa::postPay');
$routes->post('mpesa/callback',    'Mpesa::postCallback');
$routes->get('mpesa/test',         'Mpesa::getTest');
$routes->get('mpesa/checkPayment', 'Mpesa::getCheckPayment');
$routes->get('mpesa/logs',         'Mpesa::getLogs');
$routes->get('mpesa/checkcache',   'Mpesa::getCheckcache');
$routes->get('mpesa/clearcache',   'Mpesa::getClearcache');
$routes->get('mpesa/writetest', 'Mpesa::getWritetest');
$routes->get('mpesa/rawtest', 'Mpesa::getRawtest');
