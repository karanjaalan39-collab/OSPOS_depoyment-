...
<head>
    <meta charset="utf-8">
    <base href="<?= base_url() ?>">
    <title><?= esc($config['company']) . ' | ZETECH SUPERMARKET' ?></title>
    ...
    <script src="http://ospos.test/js/qz-tray.js"></script>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">ZETECH SUPERMARKET</a>
                </div>
